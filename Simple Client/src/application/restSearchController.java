...
public class restSearchController {
    ...
    @FXML
    private TextField txt_from_emp;

    @FXML
    private TextField txt_to_emp;
    ...
    void initialize() {
        ...
        assert txt_from_emp != null : "fx:id=\"txt_from_emp\" was not injected: check your FXML file 'restSearchWindow.fxml'.";
        assert txt_to_emp != null : "fx:id=\"txt_to_emp\" was not injected: check your FXML file 'restSearchWindow.fxml'.";
